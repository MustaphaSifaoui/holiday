...
$arrayfields = array(
    ...
    'cp.hdat'           => array('label' => 'StartHour', 'checked' => 1, 'position' => 35),
...
$sql = "SELECT cp.rowid, cp.ref, cp.fk_user, cp.date_debut, cp.date_fin, cp.fk_type, cp.description, cp.halfday, cp.statut as status, cp.hdat";
